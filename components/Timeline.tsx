...
const milestones = [
  {
    ...
    description: "Official IEEE CS student branch established at UCSC.",
  },
  {
    year: "2022",
    title: "First Hackathon Conducted",
    description:
      "Hosted the inaugural 24-hour coding competition with 100+ participants.",
  },
  {
    year: "2023",
    title: "National Level Workshop Series",
    description:
      "Expanded reach to invite students from universities nationwide.",
  },
  {
    year: "2024",
    title: "500 Members Milestone",
    description: "Became the largest technical student community on campus.",
  },
  {
    year: "2025",
    title: "Industry Partnership Expansion",
    description:
      "Secured partnerships with 10+ leading tech firms for internships and mentorships.",
  },
];
            ...
            {milestones.map((item, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={`md:w-[calc(50%-3rem)] w-full pl-16 md:pl-0 ${!isEven ? "md:order-3 md:text-left" : "md:text-right"}`}
                  >
                    <motion.div
                      className="bg-white p-6 rounded-2xl border border-border-gray hover:border-ieee-blue transition-colors hover:shadow-lg relative"
                    ...
                    >
                      {/* Arrow pointer */}
                      <div
                        className={`hidden md:block absolute top-1/2 -translate-y-1/2 w-4 h-4 bg-white border-t border-r border-border-gray rotate-45 ${!isEven ? "-left-2 border-b-0 border-l-0" : "-right-2 border-b-0 border-l-0"}`}
                      />
                  ...
                  <div
                    className={`md:w-[calc(50%-3rem)] hidden md:block ${!isEven ? "md:order-1" : ""}`}
                  />
                </div>
              );
            })}
