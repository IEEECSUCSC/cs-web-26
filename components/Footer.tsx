      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="lg:col-span-2 pr-4">
            ...
            <div className="flex items-center gap-4">
              <a
                href="#"
                className="text-white/60 hover:text-ieee-blue transition-colors"
              >
                <Globe size={20} />
              </a>
              <a
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <Link
                  href="#home"
                  className="font-sans text-white/70 hover:text-ieee-blue transition-colors text-sm font-medium"
                >
                  Home
                </Link>
              </li>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="font-sans text-white/50 text-sm">
            © {currentYear} IEEE Computer Society UCSC Student Branch Chapter.
            All rights reserved.
          </p>
          <div className="flex items-center gap-6">
            <a
              href="#"
              className="font-sans text-white/50 hover:text-white transition-colors text-sm"
            >
              Privacy Policy
            </a>
            <a
